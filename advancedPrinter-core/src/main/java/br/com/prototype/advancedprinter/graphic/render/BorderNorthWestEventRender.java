...
import br.com.prototype.advancedprinter.graphic.render.*;
 ...
 */
@EventRenderType(event = EventTypeEnum.BORDER_SELECTION_NW)
public class BorderNorthWestEventRender implements ComponentPageRender {
